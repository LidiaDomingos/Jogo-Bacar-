    ...
    if quantidade_de_fichas > 0:
        ...
        if soma_jogador == soma_banco:
            if pergunta_ganhador == 'e':
                ...
                print('Você tem {0} fichas!'.format(quantidade_de_fichas))
'''
#O jogo com 6 baralhos, ou seja, 312 cartas.
import random
...
while jogando:
    ...
    if pergunta_quantidade_baralho == 1:
        if quantidade_de_fichas > 0:
            ...
            if soma_jogador > soma_banco:
                if pergunta_ganhador == 'j':
                    quantidade_de_fichas = quantidade_de_fichas + aposta - 0.0129*aposta
                    print('Você tem {0} fichas!'.format(quantidade_de_fichas))
                else:
                    quantidade_de_fichas -= aposta
                    print('Você tem {0} fichas!'.format(quantidade_de_fichas))
            if soma_jogador < soma_banco:
                if pergunta_ganhador == 'b':
                    quantidade_de_fichas = quantidade_de_fichas + int(quantidade_de_fichas*0.95) - 0.0101*aposta
                    print('Você tem {0} fichas!'.format(quantidade_de_fichas))
                else:
                    quantidade_de_fichas -= aposta
                    print('Você tem {0} fichas!'.format(quantidade_de_fichas))
            if soma_jogador == soma_banco:
                if pergunta_ganhador == 'e':
                    quantidade_de_fichas = quantidade_de_fichas + quantidade_de_fichas*8 - 0.1575*aposta
                    print('Você tem {0} fichas!'.format(quantidade_de_fichas))
                else:
                    quantidade_de_fichas -= aposta
                    print('Você tem {0} fichas!'.format(quantidade_de_fichas))
